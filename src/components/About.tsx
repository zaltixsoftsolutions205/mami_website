...
const About = () => {
  return (
    <section id="about" className="py-12 md:py-20" style={{ background: "#f8fbfc" }}>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          <div>
            ...
            <div className="space-y-4" style={{ color: "#222" }}>
              ...
              <blockquote
                className="text-base md:text-lg italic border-l-4 pl-4 my-4 md:my-6"
              ...
              <h4
                className="text-lg md:text-xl font-bold mt-6 md:mt-8 mb-3 md:mb-4"
                style={{ color: SKY_BLUE }}
              >
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="p-4 md:p-6 rounded-lg text-center border-2 hover:shadow transition-colors"
                  style={{
                ...
                >
                  <stat.icon
                    className="h-8 w-8 md:h-10 md:w-10 mx-auto mb-2 md:mb-3"
                  ...
                  <div className="text-xs md:text-sm font-medium" style={{ color: "#222" }}>
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            >
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span style={{ color: GREEN, marginTop: "2px" }}>✓</span>
